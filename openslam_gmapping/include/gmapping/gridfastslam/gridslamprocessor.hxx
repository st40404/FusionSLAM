...
inline void GridSlamProcessor::scanMatch(const double* plainReading){
  ...
  for (ParticleVector::iterator it=m_particles.begin(); it!=m_particles.end(); it++){
    ...
    double score, l, s;
    // the purpose of optimize function is let current pose adjust by six change (four direction and two rotate), and return score
    ...
    // likelihoodAndScore compute sum of the weights (l)
